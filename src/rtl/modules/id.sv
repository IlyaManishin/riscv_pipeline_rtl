    ...
    always_comb begin
        ...
        if (instr.ones != 'b11) begin
            ...
            casex (case_key)
                ...
                /* LB    */  'bx_000_00000_x_x: output_controls = { 1'b1,   {1'b0, funct3},  1'bx,  1'bx,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_DMEM_OUT,     INSTR_TYPE_I,   1'b0,   1'b0 };
                /* LH    */  'bx_001_00000_x_x: output_controls = { 1'b1,   {1'b0, funct3},  1'bx,  1'bx,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_DMEM_OUT,     INSTR_TYPE_I,   1'b0,   1'b0 };
                /* LW    */  'bx_010_00000_x_x: output_controls = { 1'b1,   {1'b0, funct3},  1'bx,  1'bx,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_DMEM_OUT,     INSTR_TYPE_I,   1'b0,   1'b0 };
                /* LBU   */  'bx_100_00000_x_x: output_controls = { 1'b1,   {1'b0, funct3},  1'bx,  1'bx,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_DMEM_OUT,     INSTR_TYPE_I,   1'b0,   1'b0 };
                /* LHU   */  'bx_101_00000_x_x: output_controls = { 1'b1,   {1'b0, funct3},  1'bx,  1'bx,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_DMEM_OUT,     INSTR_TYPE_I,   1'b0,   1'b0 };
                /* SB    */  'bx_000_01000_x_x: output_controls = { 1'b0,   {1'b1, funct3},  1'bx,  1'bx,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_ANY,          INSTR_TYPE_S,   1'b0,   1'b0 };
                /* SH    */  'bx_001_01000_x_x: output_controls = { 1'b0,   {1'b1, funct3},  1'bx,  1'bx,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_ANY,          INSTR_TYPE_S,   1'b0,   1'b0 };
                /* SW    */  'bx_010_01000_x_x: output_controls = { 1'b0,   {1'b1, funct3},  1'bx,  1'bx,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_ANY,          INSTR_TYPE_S,   1'b0,   1'b0 };
                ...
                /* SRL   */  'b0_101_01100_x_x: output_controls = { 1'b1,   {1'b0, 3'b000},  1'b1,  1'b1,  SHIFT_SRL,  1'bx,  1'b1,   ALU_ANY,   WB_ALU_OUT,      INSTR_TYPE_ANY, 1'b0,   1'b1 };
                /* SRA   */  'b1_101_01100_x_x: output_controls = { 1'b1,   {1'b0, 3'b000},  1'b1,  1'b1,  SHIFT_SRA,  1'bx,  1'b1,   ALU_ANY,   WB_ALU_OUT,      INSTR_TYPE_ANY, 1'b0,   1'b1 };
