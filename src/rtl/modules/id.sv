    ...
    always_comb begin
        ...
        if (instr.ones != 'b11) begin
            ...
            casex (case_key)
                ...
                /* LB    */  'bx_000_00000_x_x: output_controls = { 1'b1,   1'b0,    1'b1,  1'b0,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_DMEM_OUT,     INSTR_TYPE_I };
                /* LH    */  'bx_001_00000_x_x: output_controls = { 1'b1,   1'b0,    1'b1,  1'b0,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_DMEM_OUT,     INSTR_TYPE_I };
                /* LW    */  'bx_010_00000_x_x: output_controls = { 1'b1,   1'b0,    1'b1,  1'b0,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_DMEM_OUT,     INSTR_TYPE_I };
                /* LBU   */  'bx_100_00000_x_x: output_controls = { 1'b1,   1'b0,    1'b1,  1'b0,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_DMEM_OUT,     INSTR_TYPE_I };
                /* LHU   */  'bx_101_00000_x_x: output_controls = { 1'b1,   1'b0,    1'b1,  1'b0,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_DMEM_OUT,     INSTR_TYPE_I };
                /* SB    */  'bx_000_01000_x_x: output_controls = { 1'b0,   1'b1,    1'b1,  1'b0,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_ANY,          INSTR_TYPE_S };
                /* SH    */  'bx_001_01000_x_x: output_controls = { 1'b0,   1'b1,    1'b1,  1'b0,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_ANY,          INSTR_TYPE_S };
                /* SW    */  'bx_010_01000_x_x: output_controls = { 1'b0,   1'b1,    1'b1,  1'b0,  SHIFT_ANY,  1'bx,  1'b1,   ALU_ADD,   WB_ANY,          INSTR_TYPE_S };
